<nav class="bg-indigo-800 shadow-xl">
        ...
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="/" class="flex items-center">
                    ...
                    <span class="ml-2 text-2xl font-bold text-white tracking-tight">Berita Seputar<span class="text-yellow-300"> Kediri</span></span>
                </a>
            </div>
            ...
            <div class="hidden md:flex md:space-x-8">
                ...
                <a href="{{ route('about') }}" class="px-3 py-2 rounded-md text-lg font-medium text-white hover:bg-blue-700 hover:text-yellow-300 transition duration-300 {{ request()->is('about') ? 'bg-blue-700 text-yellow-300' : '' }}">
                    <i class="fas fa-info-circle mr-2"></i>Tentang
                </a>
                <a href="{{ route('berita') }}" class="px-3 py-2 rounded-md text-lg font-medium text-white hover:bg-blue-700 hover:text-yellow-300 transition duration-300 {{ request()->is('news') ? 'bg-blue-700 text-yellow-300' : '' }}">
